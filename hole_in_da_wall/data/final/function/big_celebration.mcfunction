# hitwnorth:big_celebration.mcfunction （单个文件终极版）
...
#schedule function hitwnorth:temp_wave2 8t append
#schedule function hitwnorth:temp_wave3 16t append
...
tellraw @a [{"text":"    YOU HAVE SURVIVED ","color":"yellow","bold":true},{"score":{"name":"@p","objective":"survived_walls"},"color":"gold","bold":true},{"text":" WALLS!","color":"yellow","bold":true}]
